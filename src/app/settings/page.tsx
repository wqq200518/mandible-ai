...
const SettingsPage = () => {
  ...
  const handleSaveSettings = () => {
    ...
    // 显示成功消息
    setSuccessMessage(theme === 'light' ? translations[language].appearance.themeChanged : translations[language].appearance.themeChanged)
  ...
  const handleRestoreDefault = () => {
    ...
    // 显示成功消息
    setSuccessMessage(translations[language].appearance.themeChanged)
    setShowSuccessMessage(true)
